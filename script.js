let base_url = "handler.php";
        ...
        {   
            ...
            if (d.indexOf(at)==-1){
                document.getElementById('alt3').innerHTML ="**Please enter a valid E-mail ID";
                return false;
            }
        ...
        function initial7()
        {
            ...
            $.get(url,function(data,success){
                if(data.length == 0)
                {
                    document.getElementById("demo1").innerHTML="<h3><div class='container text-center'>No one has registered yet. Be the first one to register.</div></h3>";
                }
                else{
                        var text;
